...
# Model Card for rope_i_vit_reg1_b16_pn_npn_avg_c1_pe-spatial

A RoPEi ViT Reg1 B/16 image encoder from the PE-Spatial model by Bolya et al., converted to the Birder format for image feature extraction.
...
See: <https://huggingface.co/facebook/PE-Spatial-B16-512> for further details.
...
(net, model_info) = birder.load_pretrained_model("rope_i_vit_reg1_b16_pn_npn_avg_c1_pe-spatial", inference=True)
...
(net, model_info, transform) = birder.load_pretrained_model_and_transform("rope_i_vit_reg1_b16_pn_npn_avg_c1_pe-spatial", inference=True)
