...
# Model Card for vit_reg4_s14_nps_ls_dino-v2-lvd142m

A ViT Reg4 S/14 image encoder from the DINOv2 model by Oquab et al., converted to the Birder format for image feature extraction.
...
(net, model_info) = birder.load_pretrained_model("vit_reg4_s14_nps_ls_dino-v2-lvd142m", inference=True)
...
(net, model_info, transform) = birder.load_pretrained_model_and_transform("vit_reg4_s14_nps_ls_dino-v2-lvd142m", inference=True)
