...
(net, model_info) = birder.load_pretrained_model("vit_reg4_b14_nps_ls_dino-v2-lvd142m", inference=True)
...
(net, model_info, transform) = birder.load_pretrained_model_and_transform("vit_reg4_b14_nps_ls_dino-v2-lvd142m", inference=True)
