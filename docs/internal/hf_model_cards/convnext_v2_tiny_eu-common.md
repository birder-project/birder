...
# Model Card for convnext_v2_tiny_eu-common

A ConvNeXt v2 Tiny image classification model. This model was trained on the `eu-common` dataset containing common European bird species.

The species list is derived from the Collins bird guide [^1].

[^1]: Svensson, L., Mullarney, K., & Zetterström, D. (2022). Collins bird guide (3rd ed.). London, England: William Collins.

Note: A 256 x 256 variant of this model is available as `convnext_v2_tiny_eu-common256px`.
...
# Note: A 256x256 variant is available as "convnext_v2_tiny_eu-common256px"
