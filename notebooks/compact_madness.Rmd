...
param_compare_results_df = param_compare_results_df.select(pl.all().exclude("Samples / sec", "device", "ms / sample"))
...
base = cpu_compare_results_df.plot.point(
    ...
    color="Model type",
    shape="Resolution:N",
    tooltip=["ms / sample", "Parameters (M)", "Accuracy", "Top-3 accuracy", "Model name", "Model type", "Resolution"],
)
text = base.mark_text(align="center", baseline="middle", dy=-10).encode(text="Model name")
