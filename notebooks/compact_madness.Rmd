...
def get_model_name_and_num_parameters(
    ...
    model = registry.net_factory(model_name, num_classes=num_classes, input_channels=3)
...
benchmark_df = benchmark_df.with_columns(pl.col("model_name").str.replace(r"-$", ""))  # remove trailing "-"
