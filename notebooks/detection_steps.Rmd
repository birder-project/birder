...
from birder.core.net.detection.base import ImageList
from birder.core.net.detection.faster_rcnn import concat_box_prediction_layers
from birder.core.net.pretraining.base import pretrain_net_factory
from birder.core.transforms.classification import get_rgb_values, reverse_preset
...
```{python}
transform = inference_preset(size=640, rgv_values=get_rgb_values("calculated"))
reverse_transform = reverse_preset(get_rgb_values("calculated"))
```

```{python}
device = torch.device("cpu")
(net, class_to_idx, _, _, _) = cli.load_detection_checkpoint(
    device,
    "faster_rcnn",
    net_param=None,
    tag=None,
