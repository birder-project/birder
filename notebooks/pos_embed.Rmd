...
from birder.layers.rope import rotate_half
from birder.layers.rope import rotate_half_interleaved
...
```{python}
net, model_info = fs_ops.load_model(device, "hiera_abswin_base", path="models/hiera_abswin_base_mim.pt", inference=True)
```
