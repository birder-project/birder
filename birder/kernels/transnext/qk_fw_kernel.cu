...
__global__ void qk_fw_kernel(const torch::PackedTensorAccessor32<scalar_t, 4, torch::RestrictPtrTraits> queries,
...
torch::Tensor qk_fw_cu(const torch::Tensor queries, const torch::Tensor keys, int height, int width, int kernel_size,
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(queries.scalar_type(), "qk_fw_cu", ([&] {
