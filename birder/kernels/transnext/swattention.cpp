...
torch::Tensor qk_fw_cu(const torch::Tensor queries, const torch::Tensor keys, int height, int width, int kernel_size,
                       int cuda_threads);

torch::Tensor qk_forward(const torch::Tensor queries, const torch::Tensor keys, int64_t height, int64_t width,
...
std::vector<torch::Tensor> qk_bw_cu(const torch::Tensor d_attn_weight, const torch::Tensor queries,
                                    const torch::Tensor keys, int height, int width, int kernel_size, int cuda_threads);

std::vector<torch::Tensor> qk_backward(const torch::Tensor d_attn_weight, const torch::Tensor queries,
                                       const torch::Tensor keys, int64_t height, int64_t width, int64_t kernel_size,
...
std::vector<torch::Tensor> qk_rpb_bw_cu(const torch::Tensor d_attn_weight, const torch::Tensor queries,
                                        const torch::Tensor keys, int height, int width, int kernel_size,
                                        int cuda_threads);

std::vector<torch::Tensor> qk_rpb_backward(const torch::Tensor d_attn_weight, const torch::Tensor queries,
                                           const torch::Tensor keys, int64_t height, int64_t width, int64_t kernel_size,
                                           int64_t cuda_threads) {
    CHECK_INPUT(d_attn_weight);
    CHECK_INPUT(queries);
...
torch::Tensor qk_rpb_fw_cu(const torch::Tensor queries, const torch::Tensor keys, const torch::Tensor rpb, int height,
                           int width, int kernel_size, int cuda_threads);

torch::Tensor qk_rpb_forward(const torch::Tensor queries, const torch::Tensor keys, const torch::Tensor rpb,
...
torch::Tensor av_fw_cu(const torch::Tensor attn_weight, const torch::Tensor values, int height, int width,
                       int kernel_size, int cuda_threads);

torch::Tensor av_forward(const torch::Tensor attn_weight, const torch::Tensor values, int64_t height, int64_t width,
                         int64_t kernel_size, int64_t cuda_threads) {
...
std::vector<torch::Tensor> av_bw_cu(const torch::Tensor d_output, const torch::Tensor attn_weight,
                                    const torch::Tensor values, int height, int width, int kernel_size,
                                    int cuda_threads);

std::vector<torch::Tensor> av_backward(const torch::Tensor d_output, const torch::Tensor attn_weight,
                                       const torch::Tensor values, int64_t height, int64_t width, int64_t kernel_size,
                                       int64_t cuda_threads) {
