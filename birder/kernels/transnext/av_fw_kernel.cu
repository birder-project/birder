...
__global__ void av_fw_kernel(const torch::PackedTensorAccessor32<scalar_t, 4, torch::RestrictPtrTraits> attn_weight,
                             const torch::PackedTensorAccessor32<scalar_t, 4, torch::RestrictPtrTraits> values,
                             torch::PackedTensorAccessor32<scalar_t, 4, torch::RestrictPtrTraits> output, int height,
